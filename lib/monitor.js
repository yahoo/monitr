...
HealthStatus.prototype.setHealthStatus = function(isDown, statusCode, name, id) {
...
function setupHealthStatus() {
    ...
    process.monitor.getName = function() {
        return healthStatus._name;
    };

    process.monitor.getId = function() {
        return healthStatus._id;
    };
